...
```{r groceries-kable, results='hide'}
## Choose a subset
a = inspect(subset(groceryrules, lift > 4)) %>% as.data.frame
```
...
```{r groceries-3, results='hide'}
# graph-based visualization
plot(head(groceryrules, 70, by='lift'), method="graph", control=list(type="itemsets"))
saveAsGraph(head(groceryrules, 70, by='lift'), file = "groceryrules.graphml")
```
