...
airport_covid_delayed_split = initial_split(airport_covid_delayed_California, 0.8)
airport_covid_delayed_train = training(airport_covid_delayed_split)
airport_covid_delayed_test = testing(airport_covid_delayed_split)
```
