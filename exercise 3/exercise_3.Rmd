...
green.forest = randomForest(revenue ~ . - LEED - Energystar, 
                    data=green_train,
                    importance = TRUE, na.action=na.omit)
```
...
green.gbs = gbm(revenue ~ . - LEED - Energystar, 
                    data=green_train, distribution = "gaussian", n.trees = 10000,
                  shrinkage = 0.01, interaction.depth = 4, cv.folds = 5)
```
...
Therefore, we choose the gradient boosted model that has all tha variables as the features. 
